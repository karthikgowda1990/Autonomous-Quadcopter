 ...
 *  P0.0    RC-Ch1 - Roll (Ch2. of RC receiver - Grey wire)
 *  P0.1    RC-Ch2 - Pitch (Ch1. of RC receiver - White wire)
 *  P0.29   RC-Ch3 - Throttle(Ch4. of RC receiver - Orange wire)
 *  P0.30   RC-Ch4 - Yaw (Ch3. of RC receiver - Yellow wire)
 *
...
int main(void)
{
    ...
    /* Priority 13,14 available, possibly for pressure sensor computations */
